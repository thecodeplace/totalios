...
{
    return [self initWithTextField:tf dependentTextField:df withData:nil];
}
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    if([self->textField.text isEqualToString:@"Other"]){
     self->dtextField.hidden = NO;
     }
    else{
